...
subtitle: "A Marketing Tech Campaign"
author: "Netflix Technology Blog"
url: "https://netflixtechblog.com/our-learnings-from-adopting-graphql-f099de39ae5f"
tags: ['GraphQL', 'JavaScript', 'Front End Development', 'Software Engineering']
---
...
![Monet and the high-level Marketing Technology flow](../images/073d78014710b3ed.jpg)
...
![Architecture before and after GraphQL](../images/5afb020372303135.png)
...
![The flexibility of the GraphQL data model to represent different views from the same underlying data](../images/97dd040d23242d00.png)
...
![Type safety from database to backend to client code](../images/e7fca43951177d1f.png)
...
![Adding a cache to simplify data access from resolvers](../images/d952f31860655177.png)
...
![Visualization of our GraphQL Schema](../images/ea211bb2e5faa648.png)
