...
![image](../images/bd5c7218b68bdee8.png)
...
![image](../images/c9e9c38a56ae367c.png)
...
![image](../images/be0fbb2a0e3fa00d.png)
...
![image](../images/9a493a113867b10f.png)
...
![image](../images/a7858287d2229fd2.png)
...
![image](../images/8ca796041d1548cc.png)
...
- **Messaging**: Storage and retrieval of [push registry](./pushy-to-the-limit-evolving-netflixs-websocket-proxy-for-the-future-b468bc0ff658.md) for messaging needs, enabling the millions of requests to flow through.
- **Real-Time Analytics**: This persists large-scale impression and provides insights into user behavior and system performance, [moving data from offline to online](./bulldozer-batch-data-moving-from-data-warehouse-to-online-key-value-stores-41bac13863f8.md) and vice versa.
