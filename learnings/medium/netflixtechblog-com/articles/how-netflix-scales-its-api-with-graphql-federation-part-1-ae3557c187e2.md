...
tags: ['GraphQL', 'Edge Engineering', 'Microservice Architecture', 'Api Gateway', 'Architecture']
---
...
**Intro to **[**Studio Ecosystem**](./netflix-studio-engineering-overview-ed60afcfa0ce.md)
...
![Netflix Studio Content Lifecycle](../images/003a40feeeb14c91.png)
*Content Lifecycle*
...
![Studio API Graph](../images/d0de8c739fcf8a8a.png)
*Studio API Graph*

![Studio API Architecture Diagram](../images/b72dfe5e0d4ff6b8.png)
...
![Schemas & Resolvers for Studio API](../images/d6a7dc5e4f0321de.png)
...
![Federating the movie type](../images/06844edfff46b1d2.png)
*Federating Movie*
...
![Studio Edge Architecture Diagram](../images/04c950c62b7f15c2.png)
*Studio Edge Architecture*
...
![Schema Composition Phases](../images/c3d9f928b058feaf.png)
...
![Detailed federated query plan](../images/e253b77cfd450e84.png)
...
![Evolution of an API Architecture](../images/c22f211251f827d4.png)
...
_By _[_Tejas Shikhare_](https://www.linkedin.com/in/tejas-shikhare-81027b19/)
